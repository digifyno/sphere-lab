...
export const MATERIALS = {
  ...
  rubber:  { name: 'RUBBER',  color: '#e84a66', density: 1.15, restitution: 0.82, friction: 0.90, metallic: 0.03, glow: 0,    refract: 0,    pitch: 260,  timbre: 'sine',     deform: 1.0 , roll: 0.180, heatKeep: 0.9930, cond: 0.05, bounceBack: 0.85, hardness: 0.10, squashMax: 0.48, tanRest: 0.45 },
  glass:   { name: 'GLASS',   color: '#8fd0ff', density: 2.5,  restitution: 0.95, friction: 0.10, metallic: 0.20, glow: 0,    refract: 0.9,  pitch: 1500, timbre: 'sine',     deform: 0.0,  roll: 0.008, heatKeep: 0.9955, cond: 0.25, bounceBack: 0.00, fragile: true, ior: 1.5 },
  ...
  diamond: { name: 'DIAMOND', color: '#e8f4ff', density: 3.52, restitution: 0.94, friction: 0.06, metallic: 0.20, glow: 0.10, refract: 1.00, pitch: 2200, timbre: 'sine',     deform: 0.0,  roll: 0.004, heatKeep: 0.9976, cond: 0.99, bounceBack: 0.00, ior: 2.42 },
