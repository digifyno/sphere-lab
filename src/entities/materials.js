 ...
 * @property {boolean} [granular]   — angular grains: impact interlock + DEM rolling moment in the solver (sand)
 * @property {number}  [dragMul]    — air-drag multiplier (balloon ≈ 2: huge floppy envelope, high Cd)
 */
...
export const MATERIALS = {
  ...
  glass:   { name: 'GLASS',   color: '#8fd0ff', density: 2.5,  restitution: 0.93, friction: 0.32, metallic: 0.20, glow: 0,    refract: 0.9,  pitch: 1500, timbre: 'sine',     deform: 0.0,  roll: 0.008, heatKeep: 0.9955, cond: 0.25, bounceBack: 0.00, fragile: true, hardness: 0.55, ior: 1.5 },
  ...
  ice:     { name: 'ICE',     color: '#c8e8ff', density: 0.92, restitution: 0.32, friction: 0.04, metallic: 0.10, glow: 0.15, refract: 0.55, pitch: 1100, timbre: 'sine',     deform: 0.0,  roll: 0.004, heatKeep: 0.9993, cond: 0.50, bounceBack: 0.00, fragile: true, chip: 0.25, hardness: 0.15, ior: 1.31 },
  ...
  diamond: { name: 'DIAMOND', color: '#e8f4ff', density: 3.52, restitution: 0.96, friction: 0.06, metallic: 0.20, glow: 0.10, refract: 1.00, pitch: 2200, timbre: 'sine',     deform: 0.0,  roll: 0.004, heatKeep: 0.9976, cond: 0.99, bounceBack: 0.00, hardness: 1.0, ior: 2.42 },
  ...
  // metallic sheen.
  obsidian: { name: 'OBSIDIAN', color: '#1f1824', density: 2.55, restitution: 0.80, friction: 0.30, metallic: 0.70, glow: 0,    refract: 0.20, pitch: 900,  timbre: 'sine',     deform: 0.0,  roll: 0.010, heatKeep: 0.9960, cond: 0.18, bounceBack: 0.00, fragile: true, hardness: 0.60 },
  ...
  sand:    { name: 'SAND',    color: '#d8c084', density: 2.65, restitution: 0.14, friction: 0.70, metallic: 0,    glow: 0,    refract: 0,    pitch: 240,  timbre: 'square',   deform: 0.12, roll: 0.80,  heatKeep: 0.9955, cond: 0.20, bounceBack: 0.05, hardness: 0.30, granular: true },
